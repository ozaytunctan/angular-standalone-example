...
import {Control, LayerGroup, TileLayer, Map, CircleMarker} from "leaflet";
...
export class GeoService {
  ...
  constructor(private appService: AppService) {
    this.appService.getCapitals()
      .subscribe(value => this.addCapitals(value));
  }
  ...
  init(container: string): void {
    ...
    this.layersControl = new Control.Layers({ OpenStreetMap: osm })//
                        .addTo(this.map);
